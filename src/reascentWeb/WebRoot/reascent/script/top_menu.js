 ...
 * @example $(".lavaLamp").lavaLamp({ fx: "backout" });
 * @desc Creates a menu with "backout" easing effect. You need to include the
 *       easing plugin for this to work.
 * 
 * @option speed - default is 500 ms
 * @example $(".lavaLamp").lavaLamp({ speed: 500 });
 * @desc Creates a menu with an animation speed of 500 ms.
 * 
 * @option click - no defaults
 * @example $(".lavaLamp").lavaLamp({ click: function(event, menuItem) { return
 *          false; } });
	...
	$.fn.lavaLamp = function(o) {
		...
		return this.each( function(index) {
			...
			var me = $(this), noop = function() {
					...
					.appendTo(me), $li = $(">li", this), curr = $("li.current",
					this)[0]
